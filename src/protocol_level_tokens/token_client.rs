...
pub struct TokenClient {
    ...
    info:           TokenInfo,
    /// default expiration period for transaction set to 300 seconds.
    default_expiry: u32,
}
...
pub struct TransactionMetadata {
    /// Optional expiration time for the transaction. Default is 5 minutes from
    /// current time.
    expiry:   Option<TransactionTime>,
    /// Optional nonce for the transactions. Autogenerated if None.
    nonce:    Option<Nonce>,
    /// Optional flag for validating payloads. Defaults to None - no extra
    /// check.
