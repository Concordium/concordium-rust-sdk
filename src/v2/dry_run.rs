...
impl DryRunSuccessResponseWrapper {
    pub fn unwrap_response(&self) -> Result<&generated::dry_run_success_response::Response, tonic::Status> {
        match &self.response {
                ...
                match response {
                    generated::dry_run_success_response::Response::BlockStateLoaded(loaded) => {
                        ...
                        let loaded = BlockStateLoaded {
                            current_timestamp: loaded.current_timestamp.as_ref().require()?.clone().into(),
