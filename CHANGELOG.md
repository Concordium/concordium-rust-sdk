...
- Added the `affected_plt_tokens` function to the `BlockItemSummary` implementation. This function returns a vector of PLT tokens that were affected by the transaction.
